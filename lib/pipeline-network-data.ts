...
export const pipelines: PipelineFeature[] = [
  ...
  // TNGP (Trans Nigerian Gas Pipeline) - Early Gas Phase
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [7.0300, 5.4800], // ANOH
        [6.9580, 5.4520], // OB3 Connection
        [5.9000, 5.7000], // Oben
      ],
    },
    properties: {
      id: "tngp-early-gas",
      name: "TNGP Early Gas Phase",
      network: "TNGP",
      pipelineType: "trunk",
      diameter: 36,
      length: 85,
  ...
  // TNGP Phase 1 - Eastern Segment
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [7.8500, 5.0200], // Utapate/Ikot Abasi Area
        [7.5000, 5.2000], // Eastern Route
        [7.0300, 5.4800], // ANOH
      ],
    },
    properties: {
      id: "tngp-phase1-east",
      name: "TNGP Phase 1 (Eastern Segment)",
      network: "TNGP",
      pipelineType: "trunk",
      diameter: 40,
      length: 124,
  ...
  // TNGP Phase 1 - Western Extension
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [5.9000, 5.7000], // Oben
        [6.3600, 5.4500], // NAOC Kwale Area
        [6.8000, 6.7400], // Ajaokuta
      ],
    },
    properties: {
      id: "tngp-phase1-west",
      name: "TNGP Phase 1 (Western Extension)",
      network: "TNGP",
      pipelineType: "trunk",
      diameter: 36,
      length: 206,
  ...
  // TNGP Phase 2 - Northern Extension
  {
    type: "Feature",
    geometry: {
      type: "LineString",
    ...
    properties: {
      id: "tngp-phase2",
      name: "TNGP Phase 2 (Northern Extension)",
      network: "TNGP",
      pipelineType: "trunk",
      diameter: 36,
      length: 400,
  ...
  // OWEP (Odidi-Warri Expansion Pipeline)
  {
    type: "Feature",
    geometry: {
      type: "LineString",
    ...
    properties: {
      id: "owep",
      name: "OWEP (Odidi-Warri Expansion Pipeline)",
      network: "ELPS",
      pipelineType: "trunk",
      diameter: 36,
      length: 50,
  ...
  // Escravos-Odidi Pipeline
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [5.2010, 5.6113], // Escravos
        [5.7200, 5.5600], // Odidi
      ],
    },
    properties: {
      id: "escravos-odidi",
      name: "Escravos-Odidi Pipeline",
      network: "ELPS",
      pipelineType: "trunk",
      diameter: 24,
      length: 38,
  ...
  // EIIJ (ELPS-Ibadan-Ilorin-Jebba)
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [5.9000, 5.7000], // Oben/ELPS Connection
        [3.9000, 7.3800], // Ibadan
        [4.5500, 8.4900], // Ilorin
        [4.8200, 9.1200], // Jebba
      ],
    },
    properties: {
      id: "eiij",
      name: "ELPS-Ibadan-Ilorin-Jebba (EIIJ)",
      network: "ELPS",
      pipelineType: "trunk",
      diameter: 24,
      length: 380,
  ...
  // EWOGGS (East West Offshore Gas Gathering System)
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [4.7500, 4.2000], // Offshore Western
        [5.5000, 4.5000], // Offshore Mid
        [6.5000, 4.3000], // Offshore Eastern
        [6.8800, 4.5500], // Soku Connection
      ],
    },
    properties: {
      id: "ewoggs",
      name: "East West Offshore Gas Gathering System (EWOGGS)",
      network: "EWOGGS",
      pipelineType: "flow",
      diameter: 24,
      length: 180,
  ...
  // Utorogu-ELPS Pipeline
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [5.9367, 5.5145], // Utorogu
        [5.9000, 5.7000], // Oben/ELPS
      ],
    },
    properties: {
      id: "utorogu-elps",
      name: "Utorogu-ELPS (PS1 Oben Node) Pipeline",
      network: "ELPS",
      pipelineType: "flow",
      diameter: 36,
      length: 26,
  ...
  // Ogan/Agbor-Awka Pipeline
  {
    type: "Feature",
    geometry: {
      type: "LineString",
      coordinates: [
        [6.2000, 6.2500], // Ogan/Agbor Area
        [6.2100, 6.2100], // Asaba
        [7.0700, 6.2100], // Awka
      ],
    },
...
export const processingPlants: AssetFeature[] = [
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [5.7200, 5.5600],
    },
    properties: {
      id: "plant-odidi",
      name: "Odidi Gas Plant",
      assetType: "processing-plant",
      capacity: 200,
      currentOutput: 175,
      utilization: 87.5,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [6.3600, 5.4500],
    },
    properties: {
      id: "plant-naoc-kwale",
      name: "NAOC Kwale Gas Plant",
      assetType: "processing-plant",
      capacity: 300,
      currentOutput: 270,
      utilization: 90.0,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [6.9800, 4.6500],
    },
    properties: {
      id: "plant-cawthorne",
      name: "Cawthorne Channel Gas Plant",
      assetType: "processing-plant",
      capacity: 180,
      currentOutput: 160,
      utilization: 88.9,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [5.8800, 5.6500],
    },
    properties: {
      id: "plant-ovade",
      name: "Ovade Gas Plant",
      assetType: "processing-plant",
      capacity: 120,
      currentOutput: 105,
      utilization: 87.5,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [5.6200, 6.3400],
    },
    properties: {
      id: "plant-oredo",
      name: "Oredo Gas Plant",
      assetType: "processing-plant",
      capacity: 100,
      currentOutput: 85,
      utilization: 85.0,
      ...
      operationalArea: "AOMW",
      deferment: 0,
      operator: "NEPL (ND Western/NPDC JV)",
    },
  },
  {
    type: "Feature",
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [6.9900, 5.3800],
    },
    properties: {
      id: "plant-ahl-1",
      name: "AHL GP-1 (Assa North/Ohaji South)",
      assetType: "processing-plant",
      capacity: 350,
      currentOutput: 320,
      utilization: 91.4,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [7.0200, 5.4000],
    },
    properties: {
      id: "plant-ahl-2",
      name: "AHL GP-2 (Otumara)",
      assetType: "processing-plant",
      capacity: 200,
      currentOutput: 180,
      utilization: 90.0,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [7.8500, 5.0200],
    },
    properties: {
      id: "plant-utapate",
      name: "Utapate CPF (Central Processing Facility)",
      assetType: "processing-plant",
      capacity: 220,
      currentOutput: 200,
      utilization: 90.9,
      ...
      operationalArea: "AOE",
      deferment: 0,
      operator: "Frontier Oil/Sterling E&P",
    },
  },
  {
    type: "Feature",
...
export const powerPlants: AssetFeature[] = [
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [5.5900, 6.2800],
    },
    properties: {
      id: "power-azura",
      name: "Azura Power Station",
      assetType: "power-plant",
      capacity: 461,
      currentOutput: 380,
      utilization: 82.4,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [5.4200, 6.1500],
    },
    properties: {
      id: "power-wac",
      name: "WAC Power Plant",
      assetType: "power-plant",
      capacity: 50,
      currentOutput: 40,
      utilization: 80.0,
      ...
      operationalArea: "AOMW",
      deferment: 0,
      operator: "West African Ceramics",
    },
  },
];
...
export const industrialOfftakers: AssetFeature[] = [
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [3.1900, 6.8300],
    },
    properties: {
      id: "ind-ewekoro-cement",
      name: "Ewekoro Cement (Lafarge)",
      assetType: "industrial",
      capacity: 45,
      currentOutput: 38,
      utilization: 84.4,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [3.6000, 6.8200],
    },
    properties: {
      id: "ind-ibese-cement",
      name: "Ibese Cement Plant",
      assetType: "industrial",
      capacity: 50,
      currentOutput: 42,
      utilization: 84.0,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [6.7900, 7.0900],
    },
    properties: {
      id: "ind-obajana-cement",
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [10.9600, 11.4900],
    },
    properties: {
      id: "ind-ashaka-cement",
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [5.2500, 12.9200],
    },
    properties: {
      id: "ind-sokoto-cement",
      name: "Sokoto Cement Plant",
      assetType: "industrial",
      capacity: 35,
      currentOutput: 0,
      utilization: 0,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [7.0500, 4.7800],
    },
    properties: {
      id: "ind-alscon",
      name: "Aluminium Smelter Company (ALSCON)",
      assetType: "industrial",
      capacity: 180,
      currentOutput: 0,
      utilization: 0,
  ...
  },
  {
    ...
    properties: {
      ...
      corridor: "Lagos",
      deferment: 0,
      operator: "May & Baker Nigeria Plc",
    },
  },
  {
    type: "Feature",
    geometry: {
      type: "Point",
      coordinates: [5.7800, 5.5200],
    },
    properties: {
      id: "ind-time-ceramics",
      name: "Time Ceramics",
      assetType: "industrial",
      capacity: 5,
      currentOutput: 4,
      ...
      operationalArea: "AOW",
      deferment: 0,
      operator: "Time Ceramics Limited",
    },
  },
  {
    type: "Feature",
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [6.8200, 6.1400],
    },
    properties: {
      id: "ind-bua-group",
      name: "BUA Group Industrial Complex",
      assetType: "industrial",
      capacity: 40,
      currentOutput: 35,
      utilization: 87.5,
...
export const compressorStations: AssetFeature[] = [
  ...
  },
  {
    ...
    properties: {
      id: "cs-anoh-ctms",
      name: "ANOH CTMS Compressor Station",
      assetType: "compressor",
      capacity: 600,
      currentOutput: 280,
      utilization: 46.7,
  ...
  },
  {
    ...
    properties: {
      id: "cs-escravos",
      name: "Escravos Compressor Station",
      assetType: "compressor",
      capacity: 700,
      currentOutput: 620,
      utilization: 88.6,
...
export const meteringStations: AssetFeature[] = [
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [7.8500, 5.0500],
    },
    properties: {
      id: "meter-ikot-abasi",
      name: "Ikot Abasi Metering Station",
      assetType: "metering-station",
      capacity: 500,
      currentOutput: 420,
      utilization: 84.0,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [8.3200, 4.9500],
    },
    properties: {
      id: "meter-calabar",
      name: "Calabar Metering Station",
      assetType: "metering-station",
      capacity: 100,
      currentOutput: 0,
      utilization: 0,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [7.1800, 4.7200],
    },
    properties: {
      id: "meter-onne",
      name: "Onne Metering Station",
      assetType: "metering-station",
      capacity: 80,
      currentOutput: 65,
      utilization: 81.3,
  ...
  },
  {
    ...
    properties: {
      id: "meter-delta-iv",
      name: "Delta IV Metering Station",
      assetType: "metering-station",
      capacity: 200,
      currentOutput: 170,
      utilization: 85.0,
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [5.6700, 5.8900],
    },
    properties: {
      id: "meter-sapele",
      name: "Sapele Metering Station",
      assetType: "metering-station",
      capacity: 350,
      currentOutput: 295,
      utilization: 84.3,
  ...
  },
  {
    ...
    properties: {
      id: "meter-ajaokuta",
      name: "Ajaokuta Metering/Terminal Gas Station",
      assetType: "metering-station",
      capacity: 1200,
      currentOutput: 680,
      utilization: 56.7,
